    ...
    items={[
      {
        mood: "kudos",
        content:
          "Voice acting, graphics and visuals are top notch. The art style is pretty unique.",
      },
      {
        mood: "positive",
        content: "The game is well polished. Bugs go unnoticed.",
      },
      {
        mood: "negative",
...
<Section className="mt-10" title="Replayability">
  <Checklist
    className="mt-5"
    items={[
      {
